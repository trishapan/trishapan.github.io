...
function About(props) {
    return (
        ...
        <div className="text">
            ...
            <p>In 2017, I graduated from <a href="https://www.cmu.edu/">Carnegie Mellon</a> with a B.S. in Chemical Engineering, and a double major in Biomedical Engineering.</p>
            <p>I spent 3 years with <a href="https://www.accenture.com/us-en">Accenture</a> doing technology consulting while based in San Francisco.</p>
            <p>I did a coding bootcamp with <a href="https://generalassemb.ly/education/software-engineering-immersive-remote">General Assembly</a> and graduated in March 2021.</p>
            ...
            <p>
                <a href="https://www.linkedin.com/in/patricia-pan/">Linkedin</a><span> | </span>
                <a href="https://github.com/patricia-pan">Github</a><span> | </span>
                <a href="https://patricia-pan.medium.com/">Medium</a>
            </p>

            <p>
                {/* <a href="https://www.facebook.com/pat.emera.pan/">Facebook</a><span> | </span> */}
                <a href="https://ppan.substack.com/">Substack</a><span> | </span>
                <a href="https://www.instagram.com/pat.e.pan/">Instagram</a><span> | </span>
                <a href="https://twitter.com/pat_e_pan">Twitter</a>
            </p>
        </div>
    )
}
